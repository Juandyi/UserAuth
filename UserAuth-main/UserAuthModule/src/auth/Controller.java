...
public class Controller {
    ...
    private void removeUser() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
            null,
            "Desea eliminar el usuario '" + userToRemove + "'?\nEsto eliminará todos los eventos creados y publicados en el muro.",
            "Confirm Remove",
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            // Eliminar eventos y publicaciones del usuario
            // No necesitas crear una nueva instancia, usa una estática o existente
            eliminarDatosUsuario(userToRemove);
            
            JOptionPane.showMessageDialog(null, 
                "Usuario '" + userToRemove + "' y sus datos han sido eliminados correctamente.");
        }
    }

    // Método auxiliar para eliminar todos los datos del usuario
    private void eliminarDatosUsuario(String username) {
        ...
        if (file.exists()) {
            if (file.delete()) {
                ...
                System.out.println("Error: No se pudo eliminar el archivo: " + eventoFile);
            }
        }
    }
	...
	public SocialCalendarApp getSocialCalendarApp() {
		return socialCalendarApp;
	}

	public void setSocialCalendarApp(SocialCalendarApp socialCalendarApp) {
		this.socialCalendarApp = socialCalendarApp;
	}
}
